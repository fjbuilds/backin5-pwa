...
export const DEMO_ENQUIRIES = [
  ...
  // 6-9 — extra jobs clustered around Stockport so the map shows clustering
  {
    id: '6',
    ...
    town: 'Bramhall',
    source: 'WhatsApp',
    service_requested: 'Bathroom refit quote',
    urgency: 'This week',
    status: 'Needs Action',
    action_tag: 'Quote Required',
  ...
  },
  {
    ...
    service_requested: 'Kitchen install',
    urgency: 'Flexible',
    status: 'In Progress',
    action_tag: 'Quote Sent',
    created_at: daysAgo(2, 9, 5),
  },
  {
    id: '9',
    customer_name: 'Tom Beckett',
    phone: '07490 991 224',
    postcode: 'M20 2RN',
    town: 'Withington',
    source: 'Email',
    service_requested: 'Extension quote',
    urgency: 'This week',
    status: 'Booked',
    action_tag: 'Visit Required',
    appointment_datetime: aptIn(2, 14, 30),
